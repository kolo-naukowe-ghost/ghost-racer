"""
Code taken from: https://github.com/keras-rl/keras-rl/blob/master/examples/dqn_atari.py (with some modifications)
...
class GhostProcessor(Processor):
...
def train(args):
    ...
    dqn = DQNAgent(model=model, nb_actions=nb_actions, policy=policy, memory=memory, nb_steps_warmup=50000, gamma=.99, 
                        processor=processor, target_model_update=10000, train_interval=4, delta_clip=1.)
